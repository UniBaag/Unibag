...
<head>
    ...
    <link rel="stylesheet" href="../entregadores/style/style.css">
    ...
    <script src="/src/js/entregadores.js" defer></script>
...
<body class="dashboard-content">
    ...
    <main class="main-content">
        ...
        <section class="delivery-list-container">
            <h2 class="list-title">
                <div class="list-title-icon"><i class="ri-truck-line"></i></div>
            ...
            <div class="data-table">
                ...
                <div class="table-row">
                    <span class="row-item">Gabriel</span>
                    <span class="row-item">1142435362</span>
                    <span class="row-item">(252) 555-0126</span>
                    <span class="row-item">marvin@tesla.com</span>
                    <span class="row-item status-active">Ativo</span>
                </div>
                <div class="table-row">
                    <span class="row-item">Enzo</span>
                    <span class="row-item">1142435362</span>
